...
public class ShooterTestFailure extends BaseCommand {
    public final ShooterSubsystem shooter;
    public final HoodSubsystem hood;
    public final PoseSubsystem pose;

    @Inject
    public ShooterTestFailure (ShooterSubsystem shooterSubsystem, HoodSubsystem hoodSubsystem, PoseSubsystem poseSubsystem) {
