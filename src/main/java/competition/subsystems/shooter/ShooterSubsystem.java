...
public class ShooterSubsystem extends BaseSetpointSubsystem<AngularVelocity, Double> {
    ...
    public ShooterSubsystem(XCANMotorController.XCANMotorControllerFactory xcanMotorControllerFactory,
        ...
        var shooterLeftMotorDefaultPIDProperties = new XCANMotorControllerPIDProperties.Builder()
                .withP(0.05)
                .withI(0.0)
                .withD(0.0)
        ...
        var shooterMiddleMotorDefaultPIDProperties = new XCANMotorControllerPIDProperties.Builder()
                .withP(0.05)
                .withI(0.0)
                .withD(0.0)
                .withStaticFeedForward(0.02)
        ...
        var shooterRightMotorDefaultPIDProperties = new XCANMotorControllerPIDProperties.Builder()
                .withP(0.05)
                .withI(0.0)
                .withD(0.0)
                .withStaticFeedForward(0.02)
                .withVelocityFeedForward(0.011)
                .withMinPowerOutput(-1.0)
                .withMaxPowerOutput(1.0)
                .build();
