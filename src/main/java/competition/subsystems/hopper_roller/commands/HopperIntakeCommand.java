...
public class HopperIntakeCommand extends BaseCommand {
    final HopperRollerSubsystem hopperRollerSubsystem;

    @Inject
    public HopperIntakeCommand(HopperRollerSubsystem hopperRollerSubsystem) {
    ...
    public void initialize() {
        hopperRollerSubsystem.setIntakePower();
        log.info("Initialized HopperIntake");
    }
